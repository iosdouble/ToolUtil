...
//        String jsonString = JsonUtil.toJson(tokenMap);
...
//            System.out.println(string);
//
//            TokenData tokenData = JsonUtil.toObject(string,TokenData.class);
//
...
//
//
//    private  String exchange(InputStream in){
//        return exchange(in,"utf-8");
//    }
//
//    private  String exchange(InputStream in, String encode) {
//
//        String str = "";
//        try {
